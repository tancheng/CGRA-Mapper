...
class DFG {
  private:
    ...
    // list<DFGNode*>* combineSuccSame(const list<DFGNode*>*, const int);
    void combineSuccSame(const list<DFGNode*>*, const int);
    bool findOpSameSucc(const list<DFGNode*>*, const int);
    void findOpSucc(const list<DFGNode*>*, const int);
    void dualIssue(const int, const int);
    void findIFELPath(list<DFGNode*>*, const int);
    void pathMerge(list<DFGNode*>*, const int);
    void dualIssueNew(const int, const int);
